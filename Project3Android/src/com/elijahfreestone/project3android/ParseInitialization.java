...
/**
 * The Class ParseInitialization only handles Parse init.
 * This was done to stop crash related to enableLocalDatastore being
 * called within a class that extends an Activity.
 */
